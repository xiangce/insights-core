...
@mark.parametrize("obfuscate_opt", [[], ['ipv6']])
def test_obfuscate_ipv6(obfuscate_opt):
    c = InsightsConfig(obfuscate_opt=obfuscate_opt)
    pp = Cleaner(c, {})
    ip_changed = 0
    len_changed = 0
...
@mark.parametrize("obfuscate_opt", [[], ['ipv6']])
def test_obfuscate_ipv6_the_same(obfuscate_opt):
    c = InsightsConfig(obfuscate_opt=obfuscate_opt)
    pp = Cleaner(c, {})
    ip_changed = 0
    len_changed = 0
...
def test_obfuscate_ipv6_no_obfuscate():
    c = InsightsConfig(obfuscate_opt=['ipv6'])
    pp = Cleaner(c, {})
