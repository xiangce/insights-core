...
from insights.collector.cert_auth import rhsmCertificate
from insights.collector.constants import InsightsConstants as constants
from insights.collector.utilities import os_release_info
...
class InsightsConnection(object):
    ...
    #                 and rhsm_hostname != 'subscription.rhsm.stage.redhat.com'
    #             ):
    #                 logger.error(
